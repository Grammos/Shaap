...
public class CircledImageView extends ImageView {
    ...
    public CircledImageView(Context context, AttributeSet attributeSet, int defStyle)
    {
    ...
    protected void onDraw(Canvas canvas){
        ...
        Bitmap bitmap = bit.copy(Bitmap.Config.ARGB_4444, true);

        int w = getWidth(), h = getHeight();

        Bitmap roundBitmap = getCircledCroppedBitmap(bitmap, w);
    ...
    public static Bitmap getCircledCroppedBitmap(Bitmap bitmap, int radius) {
        ...
        Bitmap output = Bitmap.createBitmap(finalBitmap.getWidth(),
                finalBitmap.getHeight(), Bitmap.Config.ARGB_4444);
        ...
        canvas.drawCircle(finalBitmap.getWidth() / 2,
                finalBitmap.getHeight() / 1.8f,
                finalBitmap.getWidth() / 2.6f, paint);
